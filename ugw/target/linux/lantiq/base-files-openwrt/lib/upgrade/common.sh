...
run_ramfs() { # <command> [...]
	install_bin /bin/busybox /bin/sed /bin/echo /bin/mknod /bin/mount /bin/umount	\
	...
	install_bin /bin/busybox2 /bin/ash /bin/sh
	install_bin /usr/sbin/flash_erase                          
	install_bin /usr/sbin/flash_eraseall                       
	install_bin /usr/sbin/flash_lock                           
	install_bin /usr/sbin/flash_unlock                         
	install_bin /sbin/mtd
	install_bin /sbin/mount_root
	install_bin /usr/sbin/nanddump                             
	install_bin /usr/sbin/nandtest                             
	...
	install_bin /usr/sbin/ubirename 
	install_bin /usr/sbin/ubirsvol
	install_bin /usr/sbin/ubirmvol
	install_bin /usr/sbin/ubimkvol
	install_bin /usr/sbin/uboot_env                            
	install_bin /usr/sbin/upgrade
	install_bin /usr/sbin/vol_mgmt                             
	install_bin /usr/bin/xargs                               
