...
echo ""
echo ""
echo "Press Enter to execute test 5.2.3"
read -p "Execute 5.2.3: " exec
...
sleep 5
echo "Executing: hostapd_cli -i${interface_name} req_beacon $sta_addr 81 255 1000 50 active ff:ff:ff:ff:ff:ff rep_detail=1 rep_cond=0,0 ap_ch_report=1,6 req_elements=0,48,54,70,221"
hostapd_cli -i${interface_name} req_beacon $sta_addr 81 255 1000 50 active ff:ff:ff:ff:ff:ff rep_detail=1 rep_cond=0,0 ap_ch_report=1,6 req_elements=0,48,54,70,221
sleep 5
